...
describe QuestionsController do
  ...
  describe "POST create" do
    ...
    describe "updateing a question" do
      context "calling update on a question" do
        context "with valid parameters" do
          let(:valid_params) { {question:{title:"some new title", body:"new body"} } }
          before { put "update", valid_params({id:question.id})}

          it "should update record in db" do
            Question.find(:question.id).title == "some new title"
          end
        end
